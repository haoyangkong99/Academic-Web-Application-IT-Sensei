    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-9 d-flex align-items-center justify-content-lg-between">
          <h1 class="logo me-auto me-lg-0"><a href="userIndex.php"><?php echo $rowProfile['Website_name'] ?></a></h1>
        ...
        while ($row=mysqli_fetch_assoc($result)){ ?>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?php echo $row['tbl_course_categoryid']?> ">
            ...
            <div class="portfolio-info" >
              ...
              <p><a href="coursedetailUser.php?id=<?php echo $row['tbl_course_courseid'] ;?>"  class="details-link" title="More Details"><i class="bx bx-link"></i></a></p>
            </div>
